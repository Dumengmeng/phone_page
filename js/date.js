...
(function ($) {      
    $.fn.date = function (options,Ycallback,Ncallback) {   
        ...
        var phicommId = $("#phicomm_id").text();

        $.fn.date.defaultOptions = {
            beginyear:1970,                 //日期--年--份开始
            endyear:2000 + initY,                   //日期--年--份结束
            ...
            $("#dateconfirm").unbind('click').click(function () {	
               ...
               if(datetime){
                ...
                if(Ycallback===undefined){
                     if(docType){that.val(datestr);}else{$("#beginTime").text(datestr);}
                }else{
                     Ycallback(datestr);
                }
                $("#datePage").hide(); 
        ...
        function CreateDateUI(){
            var str = ''+
                ...
                '<div id="datePage" class="page">'+
                    '<section>'+
                        '<div id="datetitle"><p>请选择日期</p></div>'+
